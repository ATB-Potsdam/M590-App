...
const formatWaterRange = (result: NaturrasenResult): string => {
...
const formatM3Range = (result: NaturrasenResult): string => {
    if (result.isOpenRange) {
...
export const NaturrasenResultCard = ({result, fieldName, areaHa}: Props) => (
    <div className="result-card">
        ...
        <details className="result-card__block result-card__details">
            ...
            <div className="result-card__value-row">
                <span>Tabelle</span>
                <span>Tabelle 33 (DIN 18035-2:2020)</span>
            </div>
        </details>
    </div>
);
