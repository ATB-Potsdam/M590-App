...
export const PdfFieldDetail = ({field, assignment: fa, result, index, iconNormalDataUrl, iconDryDataUrl}: Props) => {
    ...
    return (
        <View>
            ...
            {/* Ergebnis */}
            <PdfErgebnisBlock result={result} iconNormalDataUrl={iconNormalDataUrl} iconDryDataUrl={iconDryDataUrl} />
        </View>
    );
};
