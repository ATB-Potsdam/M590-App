...
# usage: python3 test_polylookup.py path/to/layer.fgb 7.0 50.0 KWB
if len(sys.argv) != 5:
    print("usage: python3 test_polylookup.py <layer.fgb> <lon> <lat> <property>")
    sys.exit(2)
...
property_  = sys.argv[4].encode("utf-8")

lib = ctypes.CDLL(lib_path)
lib.load_layer.argtypes      = [ctypes.c_char_p]
lib.load_layer.restype       = ctypes.c_int
lib.query_point_json.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_char_p]
...
ptr = lib.query_point_json(lon, lat, property_)
