...
do
    ...
    python3 test_polylookup.py ../../app/public/data/Klimaraeume.fgb ${params[0]} ${params[1]} "KWB" | grep 'raw json: ' | grep -qe ",\"value\":${params[2]}\\b" && echo "SUCCESS!" || echo "FAILED!"

    # Run the C test program
    echo -n "Running C test..."
    ./test_polylookup ../../app/public/data/Klimaraeume.fgb ${params[0]} ${params[1]} "KWB" | grep 'matches: ' | grep -qe ",\"value\":${params[2]}\\b" && echo "SUCCESS!" || echo "FAILED!"
